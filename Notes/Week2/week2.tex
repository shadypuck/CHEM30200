...
\begin{itemize}
    ...
    \item \ce{Fe}, \ce{Cr}, and \ce{Mn} fluoresce under the \ce{Cu} $K_\alpha$ beam. To mitigate this effect, is it that we want to switch to an instrument that doesn't use \ce{Cu} or \ce{Co}, or swithch from one that uses \ce{Cu} to one that uses \ce{Co}.
    \begin{itemize}
